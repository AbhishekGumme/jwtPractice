...
@Component
public abstract class JwtAnthenticatinFilter extends OncePerRequestFilter
{
	//public static final String ALREADY_FTLTERED_SUFFIX=".FILTERED";
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(requestHeader!=null && requestHeader.startsWith("Bearer"))
		{
			...
			try {
				...
				logger.info("Given the jwttoken is expired");
				e.printStackTrace();
			}
		...
		if(username!=null && SecurityContextHolder.getContext().getAuthentication()==null)
		{
			...
			Boolean validatToken=this.jwtHelper.validateToken(token,userDetails);
			
			if(validatToken)
			{
				Object credentials=null;
				//set the authintiation
			...
			{
				logger.info("Validatation fails !!");
			}
		}
